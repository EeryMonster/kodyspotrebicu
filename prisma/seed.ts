...
const codes: CodeDef[] = [
  ...
  },
  {
    ...
    severityLevel: 3, canUserTrySafeChecks: false,
    safeChecks: [],
    likelyCauses: ['Vadné topné těleso', 'Vadný NTC senzor', 'Porucha relé na desce'],
    whenToStopAndCallService: ['Ihned'],
    relatedSymptoms: ['studená-voda', 'špatné-praní'],
...
const additionalCodes: CodeDef[] = [
  ...
  { brand: 'Samsung', applianceType: 'pracka', code: 'OE', altCodes: ['OC'], title: 'Přeplnění vodou – Samsung', shortMeaning: 'Hladina vody v pračce Samsung je příliš vysoká.', severityLevel: 3, canUserTrySafeChecks: false, safeChecks: [], likelyCauses: ['Vadný tlakový senzor', 'Vadný elektromagnetický ventil'], whenToStopAndCallService: ['Ihned'], relatedSymptoms: ['přeplnění', 'voda-přetéká'], possibleParts: ['Tlakový senzor', 'Elektromagnetický ventil'], faq: [], sourceType: 'official' },
  { brand: 'Samsung', applianceType: 'pracka', code: 'TE', altCodes: ['TC'], title: 'Chyba teploty vody – Samsung', shortMeaning: 'Chyba senzoru teploty nebo topného tělesa.', severityLevel: 3, canUserTrySafeChecks: false, safeChecks: [], likelyCauses: ['Vadný NTC senzor', 'Vadné topné těleso'], whenToStopAndCallService: ['Ihned'], relatedSymptoms: ['studená-voda'], possibleParts: ['NTC senzor', 'Topné těleso'], faq: [], sourceType: 'official' },
  ...
  { brand: 'Electrolux', applianceType: 'pracka', code: 'EF0', title: 'Aktivován systém proti vyplavení (Electrolux)', shortMeaning: 'Protizáplavový systém pračky Electrolux detekoval vodu ve spodní vaně – pračka se zastavila.', severityLevel: 4, canUserTrySafeChecks: false, safeChecks: [], likelyCauses: ['Únik vody z hadice nebo těsnění uvnitř pračky', 'Přetečení bubnu při nadměrném pěnění', 'Vadné těsnění bubnu nebo pumpy'], whenToStopAndCallService: ['Okamžitě – hrozí zaplavení'], relatedSymptoms: ['voda-pod-pračkou', 'únik-vody'], possibleParts: ['Těsnění bubnu', 'Přívodní hadice', 'Pumpa'], faq: [], sourceType: 'official' },
  ...
  { brand: 'Samsung', applianceType: 'pracka', code: '1E', altCodes: ['1C', 'E7'], title: 'Chyba senzoru hladiny vody Samsung', shortMeaning: 'Pračka Samsung nepřijímá signál od senzoru hladiny vody.', severityLevel: 2, canUserTrySafeChecks: false, safeChecks: [], likelyCauses: ['Vadný senzor hladiny', 'Ucpané tlakové hadičky', 'Vadná deska'], whenToStopAndCallService: ['Pokud přetrvává'], relatedSymptoms: ['pračka-se-neplní', 'přeplnění'], possibleParts: ['Senzor hladiny vody', 'Tlakový senzor'], faq: [], sourceType: 'official' },
  { brand: 'Samsung', applianceType: 'pracka', code: '8E', altCodes: ['8C', '8E1'], title: 'Chyba senzoru vibrací Samsung', shortMeaning: 'Senzor vibrací (VRT+) pračky Samsung nepracuje správně.', severityLevel: 2, canUserTrySafeChecks: false, safeChecks: [], likelyCauses: ['Vadný senzor vibrací', 'Vadná deska', 'Mechanické poškození senzoru'], whenToStopAndCallService: ['Pokud přetrvává'], relatedSymptoms: ['vibrace', 'hluk-při-praní'], possibleParts: ['Senzor vibrací VRT+', 'Hlavní deska'], faq: [], sourceType: 'official' },
  ...
  // ===== AEG PRAČKY – chybějící kódy od výrobce =====
  {
    ...
    title: 'Chyba senzoru tlaku vody (pressostat) – AEG',
    shortMeaning: 'Senzor tlaku vody hlásí poruchu nebo zasílá nesprávné hodnoty – pračka nedokáže správně řídit hladinu vody.',
    severityLevel: 3, canUserTrySafeChecks: true,
    safeChecks: [
      'Vypněte pračku a odpojte od elektřiny na 5 minut, poté znovu zapněte.',
      'Zkontrolujte, zda hadička vedoucí od tlakového senzoru není zanesená nebo zalomená.',
      'Zkontrolujte, zda není ucpaná hadicová komora (válec, do kterého hadička ústí).',
    ],
    likelyCauses: ['Vadný tlakový senzor (pressostat)', 'Ucpaná hadička tlakového senzoru', 'Porucha řídicí desky'],
    whenToStopAndCallService: ['Pokud problém přetrvává po restartu', 'Pračka se plní bez zástavy nebo se vůbec neplní'],
    relatedSymptoms: ['pracka-se-neplni', 'pracka-se-neotaci'],
    possibleParts: ['Tlakový senzor (pressostat)', 'Hadička senzoru', 'Řídicí deska'],
    faq: [
      { q: 'Co znamená kód E30 na pračce AEG?', a: 'E30 signalizuje poruchu senzoru tlaku vody. Senzor měří hladinu vody v bubnu – pokud selže, pračka neví, kolik vody napustit.' },
    ],
    sourceType: 'official',
  ...
  // ===== ELECTROLUX PRAČKY – chybějící kódy od výrobce =====
  {
    ...
    title: 'Chyba senzoru tlaku vody – Electrolux',
    shortMeaning: 'Senzor tlaku vody (pressostat) hlásí poruchu – pračka Electrolux nemůže správně řídit hladinu vody.',
    severityLevel: 3, canUserTrySafeChecks: true,
    safeChecks: [
      'Vypněte pračku a odpojte od elektřiny na 5 minut, poté znovu zapněte.',
      'Zkontrolujte hadičku tlakového senzoru – nesmí být zanesená ani zlomená.',
    ],
    likelyCauses: ['Vadný tlakový senzor (pressostat)', 'Ucpaná hadička senzoru', 'Porucha řídicí desky'],
    whenToStopAndCallService: ['Pokud přetrvává po restartu', 'Pokud se pračka plní nebo vypouští nekontrolovaně'],
    relatedSymptoms: ['pracka-se-neplni'],
    possibleParts: ['Tlakový senzor (pressostat)', 'Hadička senzoru', 'Řídicí deska'],
    faq: [
      { q: 'Co znamená E30 na pračce Electrolux?', a: 'E30 signalizuje poruchu senzoru tlaku vody. Tento senzor měří, kolik vody je v bubnu – pokud selže, pračka nefunguje správně.' },
    ],
    sourceType: 'official',
  ...
  },
  {
    ...
    severityLevel: 3, canUserTrySafeChecks: true,
    safeChecks: [
      'Snižte náplň bubnu – přeplnění může způsobit přetížení motoru.',
      'Zkontrolujte, zda v bubnu není uvíznutý kus oblečení bránící otáčení.',
      'Vypněte pračku na 10 minut a zkuste znovu spustit.',
    ],
    likelyCauses: ['Přetížený motor (přeplněný buben)', 'Vadné uhlíkové kartáče motoru', 'Vadný tacho senzor motoru', 'Porucha řídicí desky'],
    whenToStopAndCallService: ['Pokud buben nejde otočit ani ručně', 'Při opakovaném výskytu po snížení náplně'],
    relatedSymptoms: ['buben-se-neotaci'],
    possibleParts: ['Motor', 'Uhlíkové kartáče motoru', 'Tacho senzor', 'Řídicí deska'],
    faq: [
      { q: 'Co znamená E50 na pračce Electrolux?', a: 'E50 signalizuje poruchu motoru. Může jít o přeplnění pračky, opotřebované uhlíkové kartáče nebo vadný senzor motoru.' },
    ],
    sourceType: 'official',
    sourceUrl: 'https://support.electrolux.co.uk/support-articles/article/washing-machine-displays-an-error-code-how-to-fix-it',
  },
