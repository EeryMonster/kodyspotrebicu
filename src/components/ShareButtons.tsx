...
export default function ShareButtons({ code, title }: { code: string; title: string }) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      <span className="text-xs text-gray-500 font-medium">Sdílet:</span>
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 text-xs text-gray-600 hover:text-green-600 border border-gray-200 hover:border-green-300 rounded-lg px-2.5 py-1 transition-all bg-white"
      >
