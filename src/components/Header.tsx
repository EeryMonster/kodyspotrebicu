    ...
    <header className="sticky top-0 z-50 bg-white/85 backdrop-blur-md border-b border-brand-border">
      <div className="max-w-6xl mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            className="md:hidden p-2.5 -mr-2.5 min-h-[44px] min-w-[44px] flex items-center justify-center text-gray-600 shrink-0 rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
