...
export const REWRITTEN_MIELE_SLUGS = new Set<string>([
  ...
  'miele-mycka-f177',
  'miele-mycka-f601',
  'miele-mycka-blikaji-ukazatele-prubehu-programu-myti-suseni-a-konec',
  'miele-mycka-privodu-vodyotevrete-vodovodni-kohoutek',
  'miele-mycka-privod-vody-blika',
  'miele-mycka-odtok-vody',
  'miele-mycka-ostrikovaci-rameno-dole',
  'miele-mycka-ostrikovaci-rameno-nahore',
  'miele-mycka-ostrikovaci-rameno-uprostred',
  'miele-mycka-ostrikovaci-rameno-blika',
  'miele-mycka-sviti-kontrolka-lestidlo-nebo-sul',
  'miele-mycka-ukazatel-casu-blika-pri-zavrenych-dvirkach',
  'miele-mycka-vicko-nadoby-na-sulzavrete-vicko-nadoby-na-sul',
  'miele-mycka-zkontrolujte-sitkonastavte-interval',
])
